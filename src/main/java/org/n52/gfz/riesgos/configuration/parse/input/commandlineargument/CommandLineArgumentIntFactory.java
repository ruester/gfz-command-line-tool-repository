...
/**
 * Implementation to create a command line argument with an int.
 */
public class CommandLineArgumentIntFactory
     ...
     * @throws ParseConfigurationException exception that may be thrown if
     * a argument is used that is not supported for this type
     */
    @Override
