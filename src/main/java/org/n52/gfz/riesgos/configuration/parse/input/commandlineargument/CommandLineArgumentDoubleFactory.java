...
/**
 * Implementation to create a command line argument with a double.
 */
public class CommandLineArgumentDoubleFactory
    ...
    public IInputParameter create(
        ...
        if (defaultFormat != null) {
            throw new ParseConfigurationException(
                    "defaultFormat is not supported for double types");
        }
