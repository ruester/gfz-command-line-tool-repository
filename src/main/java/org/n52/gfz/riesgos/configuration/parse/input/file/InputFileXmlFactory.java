...
/**
 * Factory for the IInputParameter to deal with the parameters
 * from the configuration files.
 * This here supports general xml files with or without given schemas.
 */
public class InputFileXmlFactory implements IAsFileInputFactory {
    /**
    ...
    public IInputParameter create(
        ...
        return InputParameterFactory.INSTANCE.createFileInXml(
                identifier,
                isOptional,
                optionalAbstract,
                defaultFormat,
