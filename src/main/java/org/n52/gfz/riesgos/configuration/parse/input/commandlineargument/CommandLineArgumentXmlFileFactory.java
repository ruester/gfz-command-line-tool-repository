...
/**
 * Implementation to create a command line argument with an xml file.
 */
public class CommandLineArgumentXmlFileFactory
     ...
     * f a argument is used that is not supported for this type.
     */
    @Override
