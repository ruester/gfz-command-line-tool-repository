...
public class TestParseJsonConfigurationImpl {
    ...
    public void testValidQuakeledger() {
        ...
        try {
            ...
            final List<IIdentifierWithBinding> input = conf.getInputIdentifiers();
            final List<IIdentifierWithBinding> output = conf.getOutputIdentifiers();
            ...
            assertEquals("The first input element is a bounding box",
                    IdentifierWithBindingFactory.createCommandLineArgumentBBox("input-boundingbox", Arrays.asList("EPSG:4326", "EPSG:4328")), input.get(0));
            ...
            assertEquals("The seventh one is the etype string",
                    IdentifierWithBindingFactory.createCommandLineArgumentString("etype", null, "deaggregation", Arrays.asList("observed", "deaggregation", "stochastic", "expert")),
                    input.get(6));
